...
import { SupabaseUser, EventGoUser, EventGoBusiness, CombinedUser, Transaction, Show, Ticket, ProcessedTicket, TicketQRCode, StripeAccount, IntegratedAccount} from "./Schematics/schema.js"
...
export class DatabaseSchema{
    ...
    StripeAccount(attributes){return new StripeAccount(attributes)}
    IntegratedAccount(attributes){return new IntegratedAccount(attributes)}
}
